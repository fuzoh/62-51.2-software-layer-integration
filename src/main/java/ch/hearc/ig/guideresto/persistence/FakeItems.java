...
public class FakeItems {
    ...
    public FakeItems() {
        RestaurantType typeSuisse = new RestaurantType(1, "Cuisine suisse",
                                                       "Cuisine classique et plats typiquement suisses");
        RestaurantType typeGastro = new RestaurantType(2, "Restaurant gastronomique",
                                                       "Restaurant gastronomique de haut standing");
        ...
        EvaluationCriteria critCadre = new EvaluationCriteria(3, "Cadre",
                                                              "L'ambiance et la décoration sont-elles bonnes ?");

        City city = new City(1, "2000", "Neuchatel");

        Restaurant restaurant = new Restaurant(1, "Fleur-de-Lys", "Pizzeria au centre de Neuchâtel",
                                               "http://www.pizzeria-neuchatel.ch/", "Rue du Bassin 10", city,
                                               typeSuisse);
        ...
        restaurant = new Restaurant(2, "La Maison du Prussien", "Restaurant gastronomique renommé de Neuchâtel",
                                    "www.hotel-prussien.ch/‎", "Rue des Tunnels 11", city, typeGastro);
